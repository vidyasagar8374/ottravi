<section id="parallex" class="parallax-window bg-attachment-fixed"
    style="background: url('{{ asset('movieslist/Devara-Part-1-banner.jpg') }}') fixed;">
        ...
        <div class="row align-items-center justify-content-center h-100 parallaxt-details">
            <div class="col-xl-5 col-lg-12 col-md-12 r-mb-23">
                <div class="text-start">
                    <h2 class="big-font-5 text-uppercase texture-text mb-0"
                        style="background-image: url('{{ asset('frontend/images/pages/texure.webp') }}');">devara</h2>
                    ...
                    <div class="parallax-buttons">
                        @include('frontend::components.cards.custom-button', [
                            'buttonUrl' => route('frontend.movie_detail',['id'=>Crypt::encrypt($movieIds) ?? '']),
            ...
            <div class="col-xl-7 col-lg-12 col-md-12 mt-5 mt-xl-0">
                <div class="parallax-img">
                    <a href="{{route('frontend.movie_detail', ['id' => Crypt::encrypt($movieIds) ?? '']) }}">
                        <img src="{{ asset('movieslist/Devara-Part-1-banner.jpg') }}" class="img-fluid w-100 h-100"
